...
function str(str, opts) {
    ...
    var startdelim = escapeRegExp_js_1.escapeRegExp(opts.startDelimiter || opts.delimiter);
    var enddelim = escapeRegExp_js_1.escapeRegExp(opts.endDelimiter || opts.delimiter);
